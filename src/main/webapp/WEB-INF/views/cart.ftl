		...
		<div id="wrapper" class="container">
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					<a href="index" class="logo pull-left"><img src="/resources/themes/images/logo.png" class="site_logo" alt=""></a>
						...
						<table class="table table-striped">
							...
							<tbody>
								<tr>
									...
									<td><a href="product_detail"><img alt="" src="/resources/themes/images/ladies/9.jpg"></a></td>
								...
								<tr>
									<td><input type="checkbox" value="option1"></td>
									<td><a href="product_detail"><img alt="" src="/resources/themes/images/ladies/1.jpg"></a></td>
								...
								<tr>
									<td><input type="checkbox" value="option1"></td>
									<td><a href="product_detail"><img alt="" src="/resources/themes/images/ladies/3.jpg"></a></td>
								...
								<div class="carousel-inner">
										...
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">
													...
													<a href="product_detail"><img alt="" src="/resources/themes/images/ladies/2.jpg"></a><br/>
									...
									<div class="item">
										<ul class="thumbnails listing-products">
											<li class="span3">
												<div class="product-box">												
													<a href="product_detail"><img alt="" src="/resources/themes/images/ladies/4.jpg"></a><br/>
